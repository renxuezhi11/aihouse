package com.aihouse.aihousesys.utils;
...
public class RedisUtil {
     ...
     * @param scoure
     */
    public long zAdd(String key, Object value, double scoure) {
        try {
            Set<ZSetOperations.TypedTuple<Object>> typedTupleSet = new HashSet<>();
            ZSetOperations.TypedTuple<Object> typedTuple = new DefaultTypedTuple<Object>(value, scoure);
    ...
    /**
     * zrangeByScore返回有序集合中指定分数区间的成员列表  递增
     * @param key
     * @param scoure
     * @param scoure1
     * @return
    ...
    /**
     * 返回有序集中指定分数区间内的所有的成员  递减
     * @param key
     * @param scoure
     * @param scoure1
     * @return
     */
    public Set<Object> zrevrangebyscore(String key, double scoure, double scoure1) {
        try {
